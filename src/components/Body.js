...
import portfolio_gomeco_2 from '../assets/images/portfolio/portfolio_gomeco_2.jpg';

import portfolio_dating_website_1 from '../assets/images/portfolio/portfolio_dating_website_1.jpg';
...
import { faEarthAsia, faLocationCrosshairs, faCalculator, faCheckDouble, faEnvelope, faClockRotateLeft, faRectangleAd, faMobileButton, faComputer, faPeoplePulling, faNetworkWired, faPerson, faMoneyCheckDollar, faHighlighter, faObjectUngroup } from '@fortawesome/free-solid-svg-icons';
            ...
            <>
                <div className="body mt-5 pt-5">
                    ...
                    <header className="masthead">
                        <div className="container px-4 px-lg-5">
                            <div
                                className="row gx-4 gx-lg-5 align-items-center justify-content-center text-center"
                            >
                                <div className="col-lg-8 align-self-end">
                                    ...
                                    <h1 className="font-weight-bold pt-5">
                                        I'm
                                        <span className="font-weight-bold text-primary"> Cary Bondoc</span>
                                    </h1>
                    ...
                    <section className="page-section" id="portfolio">
                        ...
                        <div className="container">
                            ...
                            <h1 className="text-center mb-5"><em>Highlights of My Projects Since 2014</em></h1>
                            ...
                            <Row>
                                ...
                                <Col md={6} className={"text-center"}>
                                    <a href="#" onClick={this.openModalAttendance}>
                                        <img src={portfolio_base_attendance} className={"img-fluid"} width={250} />
                                    </a>
                                </Col>
                                {/* GOMECO */}
                                <Col md={6} className={"text-center"}>
                                    <a href="#" onClick={this.openModalGomeco}>
                                        <img src={portfolio_base_gmc} className={"img-fluid"} width={500} />
                                    </a>
                                </Col>
                            </Row>
                            ...
                            <Row className="mt-5">
                                ...
                                <Col md={6} className={"text-center"}>
                                    <a href="#" onClick={this.openModalTESI}>
                                        <img src={portfolio_base_tesi} className={"img-fluid"} width={250} />
                                    </a>
                                </Col>
                                {/* ITTI */}
                                <Col md={6} className={"text-center"}>
                                    <a href="#" onClick={this.openModalITTI}>
                                        <img src={portfolio_base_itti} className={"img-fluid"} width={300} />
                                    </a>
                                </Col>
                            </Row>
                        </div>
                    ...
                    <section className="page-section pt-1 text-center">
                        <Container>
                            <h3 className="mb-5 mt-5">Interested in the services that I offered? </h3>
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Row className="text-center">
                            <Col md={12}>
                                <img src={portfolio_attendance_system_1} className={"img-fluid"} width={750} />
                            </Col>
                        </Row>
                        <Row className="text-center">
                            <Col md={12}>
                                <img src={portfolio_attendance_system_2} className={"img-fluid"} width={750} />
                            </Col>
                        </Row>
                    </Modal.Body>
                </Modal>
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Row className="text-center pt-3">
                            <Col md={4}>
                                <FontAwesomeIcon className='pb-4' icon={faClockRotateLeft} size={'4x'} />
                                <p >
                                    First company website I created, way back 2014
                                </p>
                            </Col>
                            <Col md={4}>
                                <FontAwesomeIcon className='pb-4' icon={faRectangleAd} size={'4x'} />
                                <p>
                                    Static pages, focuses on advertisement
                                </p>
                            </Col>
                            <Col md={4}>
                                <FontAwesomeIcon className='pb-4' icon={faMobileButton} size={'4x'} />
                                <p>
                                    Mobile responsive, even to the last bit of pages
                                </p>
                            </Col>
                        </Row>
                        <Row className="text-center">
                            <Col md={12}>
                                <img src={portfolio_gomeco_1} className={"img-fluid"} width={750} />
                            </Col>
                        </Row>
                    </Modal.Body>
                </Modal>
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Row className="text-center pt-3">
                            <Col md={3}>
                                <FontAwesomeIcon className='pb-4' icon={faComputer} size={'4x'} />
                                <p >
                                    Powered by VB.Net and MySQL
                                </p>
                            </Col>
                            <Col md={3}>
                                <FontAwesomeIcon className='pb-4' icon={faPeoplePulling} size={'4x'} />
                                <p>
                                    Manages customer using queuing process
                                </p>
                            </Col>
                            <Col md={3}>
                                <FontAwesomeIcon className='pb-4' icon={faNetworkWired} size={'4x'} />
                                <p>
                                    Connected to another system via RS232 serial
                                </p>
                            </Col>
                            <Col md={3}>
                                <FontAwesomeIcon className='pb-4' icon={faPerson} size={'4x'} />
                                <p>
                                    Created single handedly by me, from scratch
                                </p>
                        ...
                        <Row className="text-center">
                            <Col md={12} className="mb-3">
                                <img src={portfolio_triune_1} className={"img-fluid"} width={750} />
                            </Col>
                            <Col md={12}>
                                <img src={portfolio_triune_2} className={"img-fluid"} width={750} />
                            </Col>
                        </Row>
                    </Modal.Body>
                </Modal>
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Row className="text-center pt-3">
                            ...
                            <Col md={3}>
                                <FontAwesomeIcon className='pb-4' icon={faMoneyCheckDollar} size={'4x'} />
                                <p>
                                    ECommerce, powered by Paypal
                                </p>
                            </Col>
                            <Col md={3}>
                                <FontAwesomeIcon className='pb-4' icon={faHighlighter} size={'4x'} />
                                <p>
                                    Highlights the top 3 rated products at the top
                                </p>
                            </Col>
                            <Col md={3}>
                                <FontAwesomeIcon className='pb-4' icon={faObjectUngroup} size={'4x'} />
                                <p>
                                    Basic design, emphasizes the products
                                </p>
                        ...
                        <Row className="text-center">
                            <Col md={12}>
                                <img src={portfolio_itti_1} className={"img-fluid"} width={750} />
                            </Col>
                        </Row>
                    </Modal.Body>
                </Modal>
